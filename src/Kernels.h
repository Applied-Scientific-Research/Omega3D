...
//     S is the type of the source element ('v'=vortex, 'vs'=vortex and source)
//     T is the type of the target element
//         first character is 'p' for a singular point, 'v' for a vortex blob
//         second character is 'g' if gradients must be returned
//

// thick-cored particle on thick-cored point, no gradients
template <class S, class A>
static inline void kernel_0v_0v (const S sx, const S sy, const S sz,
                                const S sr,
...
template <class S, class A>
static inline void kernel_0v_0vg (const S sx, const S sy, const S sz,
                                 const S sr,
                                 const S ssx, const S ssy, const S ssz,
                                 const S tx, const S ty, const S tz,
                                 const S tr,
...
//
template <class S, class A>
static inline void kernel_2_0v (const S sx0, const S sy0, const S sz0,
                                const S sx1, const S sy1, const S sz1,
                                const S sx2, const S sy2, const S sz2,
                                const S ssx, const S ssy, const S ssz,
  ...
  // first source point (39 flops)
  {
    ...
    (void) kernel_0v_0v (sx, sy, sz, (S)0.0,
                        strx, stry, strz,
                        tx, ty, tz, tr,
                        tu, tv, tw);
  }
...
//
template <class S, class A>
static inline void kernel_2_0vg (const S sx0, const S sy0, const S sz0,
                                 const S sx1, const S sy1, const S sz1,
                                 const S sx2, const S sy2, const S sz2,
                                 const S ssx, const S ssy, const S ssz,
                                 const S tx, const S ty, const S tz, const S tr,
  ...
  // first source point (74 flops)
  {
    ...
    (void) kernel_0v_0vg (sx, sy, sz, (S)0.0,
                          strx, stry, strz,
                          tx, ty, tz, tr,
                          tu, tv, tw,
